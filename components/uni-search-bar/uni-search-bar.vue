<template>
	<view class="uni-searchbar" :style="{width:width,margin:margin}">
		<view :style="{borderRadius:radius+'px',backgroundColor: bgColor,width:width}" class="uni-searchbar__box" @click="searchClick">
			<!-- #ifdef MP-ALIPAY -->
			...
			<!-- #endif -->
			<input v-if="show" :focus="showSync" :placeholder="placeholder" :maxlength="maxlength" @confirm="confirm" class="uni-searchbar__box-search-input" :style="{width:width}" confirm-type="search" type="text" v-model="searchVal" />
